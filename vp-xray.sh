...
draw_header() {
  ...
  echo -e "  ${WHITE}SSH Dir:${NC} ${GREEN}22, 299${NC}                 ${WHITE}Dropbear:${NC} ${GREEN}790, 550${NC}"
  echo -e "  ${WHITE}Node WS:${NC} ${GREEN}25, 2082, 2086${NC}          ${WHITE}System-DNS:${NC} ${GREEN}53${NC}"
  echo -e "  ${WHITE}Squid:${NC} ${GREEN}8000, 3128${NC}                ${WHITE}WEB-Nginx:${NC} ${GREEN}85${NC}"
  echo -e "  ${WHITE}SlowDNS:${NC} ${GREEN}5300${NC}                      ${WHITE}HysteriaUDP:${NC} ${GREEN}20k-50k${NC}"
